...
const newsLetter: NewsLetterContent = {
    title: "Join the LITE.CLUB",
    description: "Subscribe to our newsletter and get your first order. Be the first to know about new arrivals and exclusive sales.",
    discount: "15% off",
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="flex flex-col items-center text-center lg:flex-row lg:text-left lg:justify-between gap-10">
                ...
                <form className="w-full max-w-md">
                    ...
                    <p className="mt-3 text-[10px] text-slate-500 italic">{newsLetter.disclaimer}</p>
                </form>
            </div>
        </div>
        </section>
